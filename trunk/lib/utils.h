...
uchar* utils_4color_scale_draw		(uchar *rgb, uint32 w, uint32 h, Pic8u *p0,  Pic8u *p1,  Pic8u *p2,  Pic8u *p3);
...
uchar* utils_bayer_scale_draw(uchar *rgb, uint32 w, uint32 h, Pic8u *p);
...
uchar* utils_scale_draw(uchar *rgb, uint32 w, uint32 h, Pic8u *p);
uchar* utils_rgb_scale_draw(uchar *rgb, uint32 w, uint32 h, Pic8u *p);
